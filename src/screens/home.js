...
import Course1 from '../ui/course1.jpg';
...
export default function Home() {
    ...
    const [popularCourse, setpopularCourse] = useState([
        {
            ID: 1,
            title: "Computer Science 101 : Introduction to Java and Algorithms",
            tutor: {
                ID: 1,
                name:'Tristan Hull,Joshua Benz',
   ...
   {             
    ...
    return (
        ...
        <div className="section section-b rel">
                <h2 className="title s24 fontb"> Popular <span className="fontn">Things</span>   </h2>
